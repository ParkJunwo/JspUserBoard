            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="panel">
                    <div class="panel-heading text-white" style="background: #F8F8FF;">
                        <div class="row">
                            <div class="col-md-6">
                                <h2 style="padding-left: 10px;">${article.title}<!-- 글 제목 --></h2>
                            </div>
                            <div class="col-md-offset-3 col-md-3">
                                <div style="padding-top: 10px; font-size: 1.5em"><!-- 작성자 란 -->작성자:${article.writer }</div>
                                <div>
                                   조회수: ${article.hit }
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="btn-group col-md-offset-1 col-md-5"><!-- 여백 1, 공간 5 -->
                                ...
                                <c:choose>
                                	<c:when test="${user.id==article.writer }">
                                		...
                                		<a class="btn btn-danger" href="/MyWeb/delete.board?bId=${article.boardId }"
